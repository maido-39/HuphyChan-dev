...
Channel title convention kept: `YYYYMMDD HHMMSS Huphy 1.0 - <topic>` (timestamp = render time). All clips ≥ 15 s, English captions burned in, real time unless the caption says otherwise. Files in `docs/video/archive/`.

---

## 1. `huphy10_printed_model_turntable.mp4` (18 s)
...
## 2. `huphy10_ab_loop_ankle_mujoco.mp4` (15.8 s)
...
## 3. `huphy10_rp_torque_envelope.mp4` (16 s, pose sweep)
...
## 4. `huphy10_training_ab_vs_rp_iter1200.mp4` (21.6 s)
**Title:** `20260823 234427 Huphy 1.0 - RL A/B at iter 1200: closed-loop (AB) vs serial+envelope (RP) ankle`
...
## 5. `huphy10_urdf_mjcf_crosscheck.mp4` (34 s)
...
## 6. `huphy10_collision_viewer.mp4` (26 s)
**Title:** `20260823 234705 Huphy 1.0 - collision geometry web viewer (three.js) with AB mechanism playback`
