...
|---|---|---|---|---|---|
| **발 toe-off** | 3.97→1.50 | 202→**327** | **+0.49** | 4 절점 (0.0015 %) | ★**특이점** |
| **L6 골반** | 8.79→2.00 | 427→**1630** | **+0.91** | 31 절점 (0.0108 %) | ★**특이점** |
...
| 8 | **164.9 cm³** | **62.9 %** | **130.7 MPa** | **2.11** |

**37.1 % 제거에 응력 +6.7 %** — 매우 유리한 교환이다(그림 우측 곡선의 무릎이 유지율 ~70 %에서
나타난다). 각 iteration은 재솔브 + 하중경로 복구 + 볼트패드 배면 검사(min 98.8 mm 유지)를
거치므로, 세션 초기에 철회했던 "연결 안 된 섬" 문제는 재발하지 않는다.
⚠**진행 중**(목표 SF 2.0까지 14 iter 예정) — 위는 iter 8 시점 스냅샷이다.

### §25g 결론과 남은 일

1. **필렛 처방 2건**: 발 toe-off $(-103.7,118.0,-834)$ 무필렛 코너 · L6 골반 $(-0.1,132.5,60.0)$.
...
6. ⚠**L5e 쌍 재확인 필요** — 체적가중에도 13.9 % 드리프트. 메시 밀도(44.8k vs 108k)와
   체적(435.9 vs 437.4 cm³)이 달라 동일 케이스 쌍이 아닐 수 있다.
