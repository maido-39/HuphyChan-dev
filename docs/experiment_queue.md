...
| E2 | E1 + 새 PD + **무릎 belt 1.5** | knee Kd11/hip24, **무릎 RS04 belt 1:1.5**(belt 2.5→1.5; 다조건 데이터: ROUGH가 무릎토크 2배 p95 125 → 직결 2.7%불가, 1.5=0%; 반사관성 6.25→2.25×) | 충격↓+흐물거림↓, 구조하중<1.5kN, **무릎 속도 재측정**(한계 올려 진짜 demand→1.5 vs 1.3 확정) | 큐 (E1 후) |
