...
**§1b-2. 액추에이터 동역학·한계** (이 런의 `params/env.yaml` 파싱 — `2026-07-03_06-23-45`)
...
> ⚠ **파일 최신성 주의** — 이 XML은 런 시작(2026-07-03_06-23-45)보다 뒤인 2026-07-06 22:38에 수정되었다. 런 디렉토리에 모델 스냅샷이 없으므로 아래 range는 **현재 파일 기준**이며 런 당시와 다를 수 있다.
