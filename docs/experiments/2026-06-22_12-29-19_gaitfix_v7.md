...
## 1b. gaitfix_v7 Reward & Gains (config에서 파싱 — 재현용)
...
**§1b-2. 액추에이터 동역학·한계** (이 런의 `params/env.yaml` 파싱 — `2026-06-22_12-29-19_gaitfix_v7`)
...
![[2026-06-22_12-29-19_gaitfix_v7_reward.png]]
...
![[2026-06-22_12-29-19_gaitfix_v7_tensorboard.png]]
...
![[2026-06-22_12-29-19_gaitfix_v7_torque.png]]

**관절 속도 RMS/p95/MAX(rpm) vs 속도한계 가로선 + 포화%**
![[2026-06-22_12-29-19_gaitfix_v7_speed.png]]

**관절 토크 시계열 (시간에 따른 토크 활용, peak/rated 선)**
![[2026-06-22_12-29-19_gaitfix_v7_torque_ts.png]]

**관절 속도 시계열 (시간에 따른 속도 활용, limit 선)**
![[2026-06-22_12-29-19_gaitfix_v7_speed_ts.png]]
