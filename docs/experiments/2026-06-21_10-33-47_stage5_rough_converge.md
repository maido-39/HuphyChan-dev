...
## 1b. stage5_rough_converge Reward & Gains (config에서 파싱 — 재현용)
...
**§1b-2. 액추에이터 동역학·한계** (이 런의 `params/env.yaml` 파싱 — `2026-06-21_10-33-47_stage5_rough_converge`)
...
![[2026-06-21_10-33-47_stage5_rough_converge_tensorboard.png]]
