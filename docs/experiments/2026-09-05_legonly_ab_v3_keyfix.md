...
**§1b-2. 액추에이터 동역학·한계** (이 런의 `params/env.yaml` 파싱 — `2026-09-05_16-42-56_legonly_ab_v3_keyfix_p1`)
...
| L_crank_A_joint | [-68.8, 68.8] | [-61.9, 61.9] | [-61.9, 61.9] | 123.8 | 17.03 | 액션 |
| L_crank_B_joint | [-68.8, 68.8] | [-61.9, 61.9] | [-61.9, 61.9] | 123.8 | -17.26 | 액션 |
| L_ankle_pitch_joint | [-50, 30] | [-46, 26] | — (수동) | — | 20.63 | 수동 |
...
| R_crank_A_joint | [-68.8, 68.8] | [-61.9, 61.9] | [-61.9, 61.9] | 123.8 | -17.03 | 액션 |
| R_crank_B_joint | [-68.8, 68.8] | [-61.9, 61.9] | [-61.9, 61.9] | 123.8 | 17.26 | 액션 |
...
**P2 (`2026-09-06_11-06-27_legonly_ab_v3_keyfix_p2`)**: 액추에이터 게인·한계·액션 clip이 위 P1 표와 **동일** (env.yaml 대조). 달라지는 것은 도메인 랜덤화·push 등 학습 조건뿐이다.
...
| 09-06 05:44 | 9857 | 101.6 (50avg 101.5) | 1000 | 0.294 | 0.0671 | -0.44 | -0.0013 / 2.6e-04 | 0.000 / 0.083 | 0.846 / 0.856 | 0.00 / 2.5 | 2.61 | **계속** — 게이트 13(06:28): iter 9857, reward 101.6 (50avg 101.5), ep_len 1000, 낙상 0.000 / 0.083, 추종오차 0.846 / 0.856, thermal 2.61. 직전 게이트의 감시 항목이던 발열 지표는 2.77 → 2.61로 **내려와 해소**(감시선 3.0). 졸업 정착 오차 0.2585로 계속 미세 하강(문턱 0.2522). 중단 사유 없음 |
| 09-06 06:44 | 10634 | 102.2 (50avg 101.8) | 1000 | 0.292 | 0.0577 | -0.53 | -0.0008 / 1.7e-04 | 0.000 / 0.125 | 0.839 / 0.836 | 0.00 / 2.5 | 2.70 | **계속** — 게이트 14(07:30): iter 10634, reward 102.2 (50avg 101.8), ep_len 1000, 낙상 0.000 / 0.125, 추종오차 0.839 / 0.836, thermal 2.70. 보상은 100~102 사이에서 안정, 낙상 0 유지. 졸업 정착 오차 0.2569(문턱 0.2522)로 4시간 동안 0.2686→0.2569 하강 — 이 속도면 상한 도달이 먼저다. 중단 사유 없음 |
| 09-06 07:44 | 11413 | 99.5 (50avg 102.0) | 988 | 0.291 | 0.0631 | -0.59 | -0.0014 / 2.6e-04 | 0.000 / 0.083 | 0.848 / 0.838 | 0.00 / 2.5 | 2.68 | **계속** — 게이트 15(08:31): iter 11413, reward 99.5 (50avg 102.0), ep_len 988, 낙상 0.000 / 0.083, 추종오차 0.848 / 0.838, thermal 2.68. 단일 스냅샷 보상 99.5는 50회 평균 102.0 안의 흔들림(직전 게이트들도 100~102 범위). 낙상 0 유지. 졸업 정착 오차 0.2556. 남은 1단계 약 4,000회 = 약 5시간. 중단 사유 없음 |
| 09-06 08:44 | 12194 | 102.0 (50avg 102.0) | 1000 | 0.292 | 0.0634 | -0.56 | -0.0003 / 7.6e-05 | 0.000 / 0.000 | 0.837 / 0.825 | 0.00 / 2.5 | 2.73 | **계속** — 게이트 16(09:33): iter 12194, reward 102.0 (50avg 102.0), ep_len 1000, 낙상 0.000 / 0.000(낮은 몸통 종료도 0.000), 추종오차 0.837 / 0.825, thermal 2.73. **졸업 정착 오차가 0.2541로 문턱 0.2522에 근접**(6시간 전 0.2686). 이 추세면 상한 16,000회 전에 자연 졸업할 가능성이 생겼다 — 다음 게이트에서 문턱 통과와 연속 10회 유지 여부를 확인한다. 중단 사유 없음 |
| 09-06 09:45 | 12975 | 101.2 (50avg 102.2) | 1000 | 0.296 | 0.063 | -0.38 | -0.0015 / 1.7e-04 | 0.000 / 0.042 | 0.846 / 0.838 | 0.00 / 2.5 | 2.80 | **계속** — 게이트 17(10:35): iter 12975, reward 101.2 (50avg 102.2), ep_len 1000, 낙상 0.000 / 0.042, 추종오차 0.846 / 0.838, thermal 2.80. 졸업 정착 오차 **0.2529 — 문턱 0.2522까지 0.0007**(연속 유지 횟수는 아직 0/10). 남은 상한 약 2,400회(약 3시간) 안에 통과할지가 마지막 관건. 중단 사유 없음 |
| 09-06 10:45 | 13757 | 101.2 (50avg 102.3) | 1000 | 0.296 | 0.0612 | -0.37 | -0.0001 / 1.1e-04 | 0.000 / 0.000 | 0.831 / 0.850 | 0.00 / 2.5 | 2.80 | **계속** — 게이트 18(11:04): iter 13757, reward 101.2 (50avg 102.3), ep_len 1000, 낙상 0.000 / 0.000, thermal 2.80. 이 직후 **1단계 졸업**(아래 §2c-2) |
| 09-06 11:04 | 14004 | 102.5 (50avg 102.1) | 1000 | 0.295 | 0.0572 | -0.46 | 0.0018 / 5.1e-05 | 0.000 / 0.083 | 0.829 / 0.833 | 0.00 / 2.5 | 2.71 | P1 phase-end: review before P2 |
| 09-06 11:45 | 14396 | 103.5 (50avg 103.6) | 1000 | 0.285 | 0.0632 | -0.97 | -0.0015 / 2.6e-04 | 0.000 / 0.042 | 0.823 / 0.804 | 0.04 / 2.5 | 2.78 | **계속** — 2단계 게이트 1(12:11): iter 14396, reward 103.5 (50avg 103.6), ep_len 1000, 낙상 0.000 / 0.042, 추종오차 0.823 / 0.804, 무작위화 0.04 / 2.5, thermal 2.78. **보상이 1단계 말(101~102)보다 오른 103.5** — 이어받기가 정상 동작했고 무작위화 초기(4 %)라 아직 부담이 작다. 낙상 0. 중단 사유 없음 |
| 09-06 12:45 | 15016 | 104.2 (50avg 104.6) | 1000 | 0.281 | 0.0646 | -1.27 | -0.0013 / 2.6e-04 | 0.000 / 0.042 | 0.818 / 0.780 | 0.10 / 2.5 | 2.82 | **계속** — 2단계 게이트 2(13:13): iter 15016, reward 104.2 (50avg 104.6), ep_len 1000, 낙상 0.000 / 0.042, 추종오차 0.818 / 0.780, 무작위화 0.10 / 2.5, thermal 2.82. 보상이 103.5 → 104.2로 더 올랐고 추종오차도 0.823 → 0.818로 개선. 무작위화 10 % 구간까지 부담 없음. 중단 사유 없음 |
| 09-06 13:45 | 15635 | 105.8 (50avg 105.5) | 1000 | 0.274 | 0.0722 | -1.64 | -0.0015 / 1.7e-04 | 0.000 / 0.000 | 0.813 / 0.770 | 0.16 / 2.5 | 2.81 | **계속** — 2단계 게이트 3(14:14): iter 15635, reward 105.8 (50avg 105.5), ep_len 1000, 낙상 0.000 / 0.000(몸통 낮음 종료도 0.000), 추종오차 0.813 / 0.770, 무작위화 0.16 / 2.5, thermal 2.81. 세 게이트 연속 상승(103.5 → 104.2 → 105.8), 추종오차도 계속 개선(0.823 → 0.813). 무작위화 19 %. 중단 사유 없음 |
| 09-06 14:45 | 16253 | 106.4 (50avg 106.5) | 1000 | 0.268 | 0.0644 | -2.00 | -0.0025 / 1.7e-04 | 0.000 / 0.000 | 0.826 / 0.747 | 0.23 / 2.5 | 2.80 | **계속** — 2단계 게이트 4(15:16): iter 16253, reward 106.4 (50avg 106.5), ep_len 1000, 낙상 0.000 / 0.000, 추종오차 0.826 / 0.747, 무작위화 0.23 / 2.5, thermal 2.80. 네 게이트 연속 상승(103.5→104.2→105.8→106.4). 전후 추종오차는 0.813→0.826으로 소폭 올랐으나 회전 추종은 0.770→0.747로 개선 — 무작위화 23 % 구간의 정상 등락. 중단 사유 없음 |
| 09-06 15:45 | 16872 | 107.6 (50avg 107.6) | 1000 | 0.259 | 0.068 | -2.48 | 0.0014 / 5.1e-05 | 0.000 / 0.000 | 0.816 / 0.731 | 0.29 / 2.5 | 2.81 | **계속** — 2단계 게이트 5(16:18): iter 16872, reward 107.6 (50avg 107.6), ep_len 1000, 낙상 0.000 / 0.000, 추종오차 0.816 / 0.731, 무작위화 0.29 / 2.5, thermal 2.81. 다섯 게이트 연속 상승(103.5→107.6), 회전 추종 계속 개선(0.804→0.731), 낙상·몸통낮음 모두 0. 무작위화 29 %. 중단 사유 없음 |
| 09-06 16:45 | 17493 | 107.4 (50avg 108.2) | 993 | 0.253 | 0.0677 | -2.92 | -0.0006 / 7.6e-05 | 0.000 / 0.042 | 0.833 / 0.707 | 0.35 / 2.5 | 2.79 | **계속** — 2단계 게이트 6(17:19): iter 17493, reward 107.4 (50avg 108.2), ep_len 993, 낙상 0.000 / 0.042, 추종오차 0.833 / 0.707, 무작위화 0.35 / 2.5, thermal 2.79. 단일값 107.4는 직전 107.6과 사실상 동일하고 **50회 평균은 107.6 → 108.2로 계속 상승**. 회전 추종 0.707로 최저치 갱신. 낙상 0. 무작위화 38 %. 중단 사유 없음 |
| 09-06 17:45 | 18118 | 108.3 (50avg 108.4) | 1000 | 0.249 | 0.0667 | -3.12 | -0.0023 / 1.7e-04 | 0.000 / 0.000 | 0.840 / 0.704 | 0.41 / 2.5 | 2.91 | **계속** — 2단계 게이트 7(18:21): iter 18118, reward 108.3 (50avg 108.4), ep_len 1000, 낙상 0.000 / 0.000, 추종오차 0.840 / 0.704, 무작위화 0.41 / 2.5, thermal 2.91. 50회 평균 108.4로 최고치 갱신, 낙상·몸통낮음 0. 전후 추종오차는 0.813(무작위화 19 %)에서 0.840으로 서서히 오르는 중 — 무작위화가 45 %까지 올라온 대가로 보이며, 램프 종료(24,000회) 후 굳히기 구간에서 회복하는지 확인한다. thermal 2.91로 감시선 3.0 접근 — 다음 게이트 재확인. 중단 사유 없음 |
| 09-06 18:46 | 18742 | 108.2 (50avg 108.4) | 995 | 0.242 | 0.0739 | -3.48 | -0.0015 / 1.1e-04 | 0.000 / 0.083 | 0.870 / 0.691 | 0.47 / 2.5 | 2.83 | **계속** — 2단계 게이트 8(19:23): iter 18742, reward 108.2 (50avg 108.4), ep_len 995, 낙상 0.000 / 0.083, 추종오차 0.870 / 0.691, 무작위화 0.47 / 2.5, thermal 2.83. 직전 게이트의 감시 항목 둘 중 **발열은 2.91 → 2.83으로 내려와 해소**. 전후 추종오차는 0.840 → 0.870으로 계속 상승(무작위화 51 %) — 감시 유지, 램프 종료 후 회복 여부로 판단. 50회 평균 108.4 유지, 낙상 0. 중단 사유 없음 |
| 09-06 19:46 | 19339 | 109.8 (50avg 108.5) | 1000 | 0.235 | 0.0771 | -3.89 | -0.0027 / 1.1e-04 | 0.000 / 0.083 | 0.877 / 0.683 | 0.53 / 2.5 | 2.87 | **계속** — 2단계 게이트 9(20:25): iter 19339, reward 109.8 (50avg 108.5), ep_len 1000, 낙상 0.000 / 0.083, 추종오차 0.877 / 0.683, 무작위화 0.53 / 2.5, thermal 2.87. 단일값 109.8은 이 런 최고, 50회 평균 108.5. 전후 추종오차 0.877로 계속 상승(무작위화 57 %) — 감시 유지. 회전 추종은 0.683으로 계속 개선. 낙상 0. 중단 사유 없음 |
| 09-06 20:46 | 19951 | 107.6 (50avg 108.2) | 993 | 0.230 | 0.0738 | -4.17 | -0.0010 / 1.7e-04 | 0.000 / 0.083 | 0.922 / 0.689 | 0.60 / 2.5 | 2.88 | **계속** — 2단계 게이트 10(21:28): iter 19951, reward 107.6 (50avg 108.2), ep_len 993, 낙상 0.000 / 0.083, 추종오차 0.922 / 0.689, 무작위화 0.60 / 2.5, thermal 2.88. 전후 추종오차 **0.922로 감시 시작 이래 최고**(0.813 → 0.840 → 0.870 → 0.877 → 0.922, 무작위화 60 %와 같은 방향). 50회 평균 보상은 108.2로 유지되고 낙상 0이라 **중단 사유는 아니다**. 판단 시점은 램프 종료(24,000회) 후 굳히기 구간 — 그때도 0.9 위면 v2 완주본(0.586)과의 격차를 완주 측정에서 정면으로 다룬다. 중단 사유 없음 |
| 09-06 21:46 | 20575 | 108.3 (50avg 108.6) | 1000 | 0.224 | 0.0752 | -4.56 | -0.0011 / 1.1e-04 | 0.000 / 0.042 | 0.931 / 0.677 | 0.66 / 2.5 | 2.94 | **계속** — 2단계 게이트 11(22:30): iter 20575, reward 108.3 (50avg 108.6), ep_len 1000, 낙상 0.000 / 0.042, 추종오차 0.931 / 0.677, 무작위화 0.66 / 2.5, thermal 2.94. 50회 평균 108.6으로 소폭 상승, 낙상 0, 에피소드 길이 1000 만기. 전후 추종오차 0.931(무작위화 66 %)로 감시 유지, 회전 추종은 0.677로 계속 개선. thermal 2.94 — 감시선 3.0 근접, 다음 게이트 재확인. 중단 사유 없음 |
| 09-06 22:46 | 21201 | 106.3 (50avg 108.5) | 985 | 0.219 | 0.0803 | -4.91 | -0.0013 / 1.1e-04 | 0.000 / 0.125 | 0.930 / 0.686 | 0.72 / 2.5 | 2.96 | **계속** — 2단계 게이트 12(23:31): iter 21201, reward 106.3 (50avg 108.5), ep_len 985, 낙상 0.000 / 0.125, 추종오차 0.930 / 0.686, 무작위화 0.72 / 2.5, thermal 2.96. 50회 평균 108.5 유지(단일 106.3은 평균 안 등락), 낙상 0. 전후 추종오차 0.930으로 **상승이 멈춤**(0.922 → 0.931 → 0.930). thermal 2.96 — 감시선 3.0 바로 아래, 다음 게이트 재확인. 무작위화 램프는 72 %, 24,000회에서 종료. 중단 사유 없음 |
| 09-06 23:46 | 21821 | 108.6 (50avg 108.6) | 1000 | 0.212 | 0.0849 | -5.38 | -0.0022 / 1.1e-04 | 0.000 / 0.083 | 0.942 / 0.668 | 0.78 / 2.5 | 2.95 | **계속** — 2단계 게이트 13(09-07 00:34): iter 21821, reward 108.6 (50avg 108.6), ep_len 1000, 낙상 0.000 / 0.083, 추종오차 0.942 / 0.668, 무작위화 0.78 / 2.5, thermal 2.95. 50회 평균 108.6으로 최고치 타이, 에피소드 1000 만기, 낙상 0. 전후 추종오차 0.942(무작위화 78 %) — 램프 종료 24,000회까지 1,700회 남음, 굳히기 구간에서 회복 여부가 판단 시점. thermal 2.95 유지. 중단 사유 없음 |
| 09-07 00:47 | 22439 | 106.6 (50avg 108.1) | 981 | 0.204 | 0.0877 | -5.87 | -0.0019 / 1.7e-04 | 0.000 / 0.333 | 0.953 / 0.677 | 0.84 / 2.5 | 3.00 | **계속(감시 2건)** — 2단계 게이트 14(01:36): iter 22439, reward 106.6 (50avg 108.1), ep_len 981, 낙상 0.000 / 0.333, 추종오차 0.953 / 0.677, 무작위화 0.84 / 2.5, thermal 3.00. **발열 지표가 감시선 3.00에 정확히 닿았다** — 다만 같은 시각 로그 직접 확인값은 2.86~2.88로, 3.00은 스냅샷 한 점의 고점이다. **몸통 낮음 종료가 0.083 → 0.333으로 상승**(로그 직접값 0.208). 전체 종료의 약 1 %대이고 낙상은 여전히 0.000이라 보수적 중단 기준에는 미달. 중단 조건 명시: 다음 두 게이트에서 발열이 3.0 위에 계속 머물거나, 몸통 낮음 종료가 계속 오르면서 50회 평균 보상이 105 아래로 내려가면 중단하고 직전 체크포인트로 판단한다. 현재 평균 108.1로 정상 |
| 09-07 01:47 | 23050 | 107.6 (50avg 107.9) | 999 | 0.198 | 0.0851 | -6.27 | -0.0013 / 1.7e-04 | 0.000 / 0.083 | 1.005 / 0.669 | 0.91 / 2.5 | 2.95 | **계속 — 중단조건 1/2 관찰** — 2단계 게이트 15(02:23): iter 23050, reward 107.6 (50avg 107.9)(50평균 107.9), ep_len 999, 낙상 0.000 / 0.083, thermal 2.95. 게이트 스냅샷은 2.95지만 **로그 직접값은 3.007 → 3.016으로 문턱 3.0을 두 지점 연속 넘음** — 지난 게이트에서 정한 중단조건 1(발열이 다음 두 게이트에서 3.0 위 유지)의 **1/2 관찰**. 몸통낮음 종료는 0.125로 오히려 내려와 상승 추세 아님(조건 2 미해당). 50평균 보상 107.9로 105 훨씬 위. **아직 중단 아님** — 다음 게이트에서 발열이 또 3.0 위면 그 시점 체크포인트로 중단, 아니면 해제 |
| 09-07 02:47 | 23668 | 107.3 (50avg 107.2) | 1000 | 0.192 | 0.0829 | -6.67 | -0.0023 / 1.1e-04 | 0.000 / 0.083 | 0.996 / 0.683 | 0.97 / 2.5 | 2.96 | **계속 — 중단조건 해제** — 2단계 게이트 16(03:10): iter 23668, reward 107.3 (50avg 107.2)(50평균 107.2), ep_len 1000, 낙상 0.000 / 0.083, thermal 2.96. 발열 로그 직접값 2.951 → 2.964 → 2.967로 **3.0 아래 복귀 확인**(3.007/3.016은 일시 고점이었음) — **중단조건 1 해제**. 몸통낮음도 0.125로 등락 안 오름(조건 2 해당 없음). 낙상 0 유지, 보상 105 위. 무작위화 램프 99 %, **24,000회에 종료 임박** — 다음 게이트는 램프 종료 직후 추종오차 회복 여부를 판단한다 |
| 09-07 03:47 | 24296 | 107.3 (50avg 107.9) | 991 | 0.182 | 0.0923 | -7.44 | -0.0011 / 1.1e-04 | 0.000 / 0.292 | 1.032 / 0.669 | 1.00 / 2.5 | 2.95 | **계속 — 램프 종료, 굳히기 시작** — 2단계 게이트 17(04:12): iter 24296, reward 107.3 (50avg 107.9)(50평균 107.9), ep_len 991, 낙상 0.000 / 0.292, 추종오차 1.032 / 0.669, thermal 2.95. **무작위화 dr_factor = 1.0 도달**(24,000회) — 이제 4,000회 굳히기 구간(→28,000회). 전후 추종오차 1.032로 감시 시작 이래 최고지만, §2c-1에서 정한 판단 시점이 바로 이 램프 종료 이후라 **아직 판정 보류** — 굳히기 4,000회 동안 회복 추세를 본다. 몸통낮음 0.292는 등락 범위 내(0.083~0.375). 낙상 0. 중단 사유 없음 |
| 09-07 04:48 | 24925 | 109.7 (50avg 109.7) | 989 | 0.171 | 0.0896 | -8.27 | -0.0029 / 7.6e-05 | 0.000 / 0.250 | 1.017 / 0.639 | 1.00 / 2.5 | 2.90 | **계속 — 굳히기 1시간, 소폭 회복** — 2단계 게이트 18(05:14): iter 24925, reward 109.7 (50avg 109.7)(**50평균 109.7, 이 런 최고**), ep_len 989, 낙상 0.000 / 0.250, 추종오차 1.017 / 0.639, thermal 2.90. 전후 추종오차 1.032 → 1.017로 소폭 하락, 회전 추종은 0.639로 계속 개선. 굳히기 구간 4,000회 중 925회 경과 — 완전 회복은 아니나 악화도 아님. 낙상 0. 중단 사유 없음 |
| 09-07 05:48 | 25554 | 109.6 (50avg 110.7) | 993 | 0.163 | 0.0895 | -8.91 | -0.0005 / 1.1e-04 | 0.000 / 0.125 | 1.023 / 0.636 | 1.00 / 2.5 | 2.91 | **계속 — 새 최고치** — 2단계 게이트 19(06:16): iter 25554, reward 109.6 (50avg 110.7)(**50평균 110.7, 갱신**), ep_len 993, 낙상 0.000 / 0.125, 추종오차 1.023 / 0.636, thermal 2.91. 전후 추종오차 1.023으로 1.017~1.032 사이 등락(뚜렷한 회복도 악화도 아님). 회전 추종 0.636 계속 개선. 낙상 0. 남은 약 2,150회. 중단 사유 없음 |
| 09-07 06:48 | 26184 | 113.6 (50avg 111.9) | 998 | 0.152 | 0.0857 | -9.81 | -0.0012 / 1.1e-04 | 0.000 / 0.167 | 0.990 / 0.598 | 1.00 / 2.5 | 2.99 | **계속 — 추종오차 회복 확인** — 2단계 게이트 20(07:03): iter 26184, reward 113.6 (50avg 111.9)(**50평균 111.9, 최고 갱신**), ep_len 998, 낙상 0.000 / 0.167, thermal 2.99. **전후 추종오차 0.990으로 램프 종료 이후 처음 1.0 아래 복귀**(1.032 → 1.017 → 1.023 → **0.990**) — §2c-1의 판단 시점 통과, 굳히기 구간에서 회복 확인됨. 낙상 0. 남은 약 1,700회, 완주 임박. 중단 사유 없음 |
| 09-07 07:48 | 26813 | 113.3 (50avg 112.8) | 1000 | 0.143 | 0.0906 | -10.60 | -0.0015 / 7.6e-05 | 0.000 / 0.167 | 1.007 / 0.588 | 1.00 / 2.5 | 3.00 | **계속 — 새 최고치** — 2단계 게이트 21(08:15): iter 26813, reward 113.3 (50avg 112.8)(**50평균 112.8, 최고 갱신**), ep_len 1000, 낙상 0.000 / 0.167, 추종오차 1.007 / 0.588, thermal 3.00. 전후 추종오차 1.007로 회복 유지, 회전 추종 0.588로 계속 개선. thermal 3.00은 스냅샷 한 점 — 보상·낙상 모두 정상이라 중단 사유 아님(직전 중단조건은 이미 해제됨). 남은 926회, 완주 30분 이내 예상 |
| 09-07 08:49 | 27443 | 113.8 (50avg 113.9) | 995 | 0.133 | 0.0769 | -11.53 | -0.0006 / 7.6e-05 | 0.000 / 0.042 | 1.019 / 0.574 | 1.00 / 2.5 | 3.01 | **계속 — 새 최고치** — 2단계 게이트 22(09:18): iter 27443, reward 113.8 (50avg 113.9)(**50평균 113.9, 최고 갱신**), ep_len 995, 낙상 0.000 / 0.042, 추종오차 1.019 / 0.574, thermal 3.01. 전후 추종오차 1.019(등락 범위 내), 회전 추종 0.574로 계속 개선. thermal 3.01은 여전히 스냅샷 고점 수준, 보상·낙상 정상. 남은 276회, 완주 10분 이내 예상 |
| 09-07 09:43 | 27999 | 115.4 (50avg 114.2) | 991 | 0.125 | 0.0871 | -12.32 | 0.0040 / 2.3e-05 | 0.000 / 0.167 | 1.009 / 0.557 | 1.00 / 2.5 | 3.01 | **완주** — iter 27,999(전 학습 최고 보상), 낙상 0, 정책·값함수 손실 모두 낮은 값에서 안정. 전후 추종오차 1.009로 굳히기 구간의 회복 수준 유지, 발열 3.01(스냅샷 고점 수준, 로그 평균은 계속 2.8~2.9대). 다음은 계획된 완주 후 측정(보행 운동학 → 전체 명령 범위 부하). |
...
## §2c-2 1단계 졸업 (2026-09-06 11:04)

**결과: 상한(16,000회)에 닿기 전에 심판 조건을 스스로 통과했다.** §2c-1에서 정리한 선택지 A(그대로 두기)로 진행한 결과이며, 수동 개입은 하지 않았다.

| 항목 | 값 |
|---|---|
| 종료 반복 | **14,000회** (상한 16,000회) |
| 종료 사유 | `settled at top stage` — 정착 오차 0.2522 ≤ 문턱 0.2522(기준 0.2293 × 1.1)를 **연속 11회** 유지 |
| 마지막 단계 체류 | 10,798회 |
| 낙상 | 0.0000 |
| 강제 승격 | **0회** (다섯 단계 모두 정상 게이트 통과, v2와 동일) |
| 체크포인트 | `2026-09-05_16-42-56_legonly_ab_v3_keyfix_p1/model_14000.pt` |
| 소요 | 18시간 22분 |

**§2c-1의 예측 정정.** "이 속도면 상한 도달이 먼저"라고 세 번 적었으나 틀렸다. 정착 오차는 6시간에 걸쳐 0.2686 → 0.2522로 꾸준히 내려왔고 마지막 30분에 문턱을 통과했다.
수동 졸업(선택지 B)을 실행하지 않은 것이 결과적으로 옳았다 — 개입했다면 5,000회 덜 학습한 정책으로 2단계에 들어갔을 것이다.

**v2와 비교.** v2는 4,100회에 졸업(정착 오차 0.2478, 기준 0.2336 → 비율 1.056), v3는 14,000회(0.2522 / 0.2293 → 1.100). v3의 기준값이 더 낮아(4단계에서 더 잘 걸었다는 뜻) 문턱도 더 빡빡했고, 그만큼 오래 걸렸다.
1단계 길이가 3.4배 다르므로 **v2와의 A/B는 "같은 학습량"이 아니다**. 세대 비교는 §3·§4의 같은 4,100회 지점 자료를 쓰고, v3 완주본은 그 자체의 절대 성능으로 판정한다.

**다음: 2단계** — 무작위화를 10,000회에 걸쳐 올리고(14,000 → 24,000회) 4,000회 굳히기(→ 28,000회). 관측 속도 약 765회/시간 기준 약 18시간, 완주 예상 **09-07 05시경**.

## §2c-3 2단계 발사 (2026-09-06 11:05)

1단계 체크포인트 `model_14000.pt`에서 **완전 이어받기**로 시작했다(관측·비평가 구조가 같아 그대로 이어진다).

| 항목 | 값 |
|---|---|
| 프로세스 | pid 2624767, 로그 `logs/legonly_ab_v3_keyfix_p2.log` |
| 런 디렉터리 | `logs/rsl_rl/pygmalion_velocity/2026-09-06_11-06-27_legonly_ab_v3_keyfix_p2` (재현 스냅샷 포함) |
| 반복 구간 | 14,000 → **27,999회** (2단계 14,000회) |
| 무작위화 | 14,000 → 24,000회에 걸쳐 0 → 1로 올림, 이후 4,000회 굳히기 |
| 탐색 노이즈 | 0.01 → 0.002로 2단계 전 구간에 걸쳐 감소 (1단계에는 없던 일정) |
| 설정 | **33개** (1단계 27개 + 무작위화·노이즈 일정 6개). 옛 시작 자세 플래그 없음 = 새 시작 자세 유지 |
| 명령 범위 | 마지막 단계로 고정(전후 −2.0~2.5, 좌우 ±1.0, 회전 ±1.0). 2단계에서는 범위를 바꾸지 않고 무작위화만 올린다 |

관측 속도 기준 완주 예상 **09-07 05시경**. 감시는 1시간 게이트·워치독·리뷰루프 그대로.
...
## §5 완주 판정 (2026-09-07 09:43)

**1단계 14,000회(정상 졸업) + 2단계 14,000회(무작위화 램프 10,000 + 굳히기 4,000), 총 27,999회.** 최종 체크포인트 `2026-09-06_11-06-27_legonly_ab_v3_keyfix_p2/model_27999.pt`.

| 항목 | 값 |
|---|---|
| 최종 보상 | 115.4 (50회 평균 114.2, **전 학습 최고**) |
| 낙상 | 0.0000 (전 구간) |
| 정착 성공(1단계 졸업) | iter 14,000, 정착 오차 0.2522 ≤ 문턱, 연속 11회, 강제 승격 0회 |
| 무작위화 램프 후 추종오차 | 1.032(피크) → 0.990 → 1.009(종료 시점) — **회복 확인**(§2c-1의 판단 시점 통과, 게이트 20) |
| 발열 | 게이트 표에서 최고 3.01(스냅샷 순간값), 직접 로그 평균은 대부분 2.8~2.9대 |
| 총 소요 | 09-05 16:42:46 발사 → 09-07 09:43:15 완주, **약 41시간 1분** |

**다음 단계 — 완주 후 정식 측정(§1c 계획대로)**: 새 시작 자세로 보행 운동학(0.6·1.2 m/s, 초기 자세 흔든 3회), 전체 명령 범위 부하(외란 없음·주입, 121개 명령), 모터 활용도·추종표, 근접·개요 영상.
비교 대상은 §3·§4의 같은 4,100회 지점 자료(세대 비교)와 v2 완주본(18,099회, 절대 성능)이다. §1c 판정 기준(무릎 스윙 좌우차 절반 이하, 크랭크 토크 비율 1.2 이하, 무릎 55~65도, 회귀 없음)을 이 측정으로 확정한다.
