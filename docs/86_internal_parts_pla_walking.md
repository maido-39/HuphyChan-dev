# 86. 링크 내부 부품 PLA 위험 순위 — 단순 보행 기준 (2026-08-20)
...
|---|---|---|---|---|---|---|
| 1 | **하드 스토퍼 패드** (+30 설계캡) | 패드 전단 피로 | 10.0 MPa (873 N, P99) | 0.65 MPa | **0.07** | **0.1 h** |
| 2 | **푸시로드 A** | 오일러 좌굴 (압축 피크) | 365 N | **53 N** (E 2.3 GPa) | **0.14** | 즉시 |
| 3 | **크랭크 A / B** | 허브 굽힘 피로 | 19.1 / 17.6 MPa | 3.4 MPa | **0.18 / 0.19** | 0.06 / 0.1 h |
| 4 | 푸시로드 A / B | 인장 피로 | 10.4 / 8.9 MPa | 3.4 MPa | 0.33 / 0.38 | 1.8 / 4.2 h |
| 5 | 푸시로드 B | 오일러 좌굴 | 308 N | 139 N | 0.45 | 즉시 |
| 6 | 클레비스 포크 암 | 전후 굽힘 피로 | 6.1 MPa | 3.4 MPa | 0.56 | 35 h |
