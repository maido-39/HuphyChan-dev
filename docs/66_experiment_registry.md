...
| **ankleAB_c3 / ankleRP_c3** "flat-2.5max gen21-bundle+**soft-landing** curriculum-dr+push ankle-AB / -RP (2026-08-24)" (`03-22-35` / `03-22-58`, 🔄학습중 20.4k/32k, vx2.5·DR~0.9, ETA 08-25 20:20) [[2026-08-24_ankleAB_c3]] [[2026-08-24_ankleRP_c3]] | c2 + `PYG_SOFT_LANDING` (foot_impact_velocity Σrelu(−v_z)²·[h<0.10∧공중] w −1, contact_force_cap 420/560 N) — 두 arm 동일, 3100까지 이력 동일 | 시험(AB 3100+800, 1024env): 접지속도 1.24→0.98 m/s, GRF 피크 1.50→1.31 BW, 추종 유지, 스윙높이 0.116→0.080 m(감시) | 🔄 4k(vx1.2): AB 0.90 m/s·1.00 BW / RP 1.14·1.22 · 8k(vx1.6): **RP가 더 부드러움** 0.85·1.03 vs AB 0.93·1.23, 접지 p90 1.96 꼬리, ⚠AB 정지 제자리걸음(발움직임 0.115 m/s·duty 0.87→12k 재확인). 스윙 0.112/0.082 m > 역치 → w −1 유지. 1:1 영상·그림 [[93_ankle_ab_rp_comparison_plan]] §5c. ★err_vel 0.69는 지표 아티팩트(=평균 0.276×2.5, [[96_tracking_error_bottleneck]]) — 정상상태 AB 0.17/RP 0.24, RP ankle_pitch T-N 82%. 항별추세 [[97_c3_reward_trend_review]]: 커리큘럼 적응 <20 iter(간격 4000 과잉)·σ 0.30→0.38 어닐링 없음·torque_limit weight 0(RP 발목 T-N 82% 포화)·slip 2배 드리프트. 12k: AB 정지 제자리걸음 해소(0.005)·RP 더 부드러움(1.02BW/53BW·s⁻¹); **평가기 96ep 성공률 100%·추종 0.10–0.14**(단일롤아웃 프로브는 게이트 부적격 §95 §7b). 16k(vx2.5·DR0.82): 낙상 0 유지·reward 104→91(커리큘럼분), **품질 3종 악화**(slip 0.28·excess 9.4·low_base 0.167) — 20k DR 만배가 시험대. AB/RP 정량비교 [[101_policy_spec_and_final_plan]] §5: **에너지 RP 우세**(CoT 0.277 vs 0.314, 1 m/s에서 20 W)·**충격 무승부**(4게이트 쌍대차가 σ 안)·**발목 모터 여유 AB 2.2배**(35–38 % vs 82 %, 포화 0 vs 3.7 %); 손해는 발목이 아니라 무릎(+63 %)·힙요(+78 %). 차기 세대 계획 [[98_scratch_training_plan]](게이트형 커리큘럼·entropy 어닐링·T-N 토크항·2시드). 선형형은 해킹(2.42 m/s)으로 기각 — [[95_soft_landing_prescription]] |
