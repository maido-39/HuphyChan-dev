...
| **ankleAB_c3 / ankleRP_c3** "flat-2.5max gen21-bundle+**soft-landing** curriculum-dr+push ankle-AB / -RP (2026-08-24)" (`03-22-35` / `03-22-58`, 🔄30.6k/32k, 각 model_3100에서 warm-start) [[2026-08-24_ankleAB_c3]] [[2026-08-24_ankleRP_c3]] | c2 + `PYG_SOFT_LANDING`(제곱 접지속도 w −1·h 0.10, GRF 캡 420/560) — 두 arm 동일, **유일 변인 = 발목 기구학** | **낙상 0/38 h(양쪽, vx 2.5·DR 만배 포함)**. 에너지 **CoT RP 0.277 vs AB 0.314(−12 %, 속도 오를수록 격차↑)**, 충격 **무승부**(4게이트 쌍대차 표준편차 내), 모터 여유 **AB 압도**(발목 T-N 35–38 % vs RP 82 %·포화 3.7 %), 보행 **보폭 AB 273 vs RP 175 mm(+56 %)**·duty 동률 0.55·파형은 AB가 인간에 근접, 추종은 **0.8 m/s AB 우세 / 1.2 m/s RP 32 % 우세** | 🔄 완주 후 fc/fcp·전체 격자 평가 예정. 분석: [[101_policy_spec_and_final_plan]] [[97_c3_reward_trend_review]] [[96_tracking_error_bottleneck]] [[95_soft_landing_prescription]] |
