...
| **bundleV4_AB** "v4 mass, 31.316 kg (2026-08-27)" (16384 env, AB c3 +800, 🔄 진행) | D1 레시피 + **`PYG_MODEL_V4=1`** — 질량만 35.347 → 31.316 kg(어깨 출력물 밀도 + 실측 IMU site). 형상 메쉬는 아직 08-22 STEP | 진행 중 | 🔄 |
