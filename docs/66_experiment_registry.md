...
| **ankleAB_c3 / ankleRP_c3** "flat-2.5max gen21-bundle+**soft-landing** curriculum-dr+push ankle-AB / -RP (2026-08-24)" (`03-22-35` / `03-22-58`, 🔄학습중, 각 model_3100에서 warm-start, 총 32k) [[2026-08-24_ankleAB_c3]] [[2026-08-24_ankleRP_c3]] | c2 + `PYG_SOFT_LANDING` (foot_impact_velocity Σrelu(−v_z)²·[h<0.10∧공중] w −1, contact_force_cap 420/560 N) — 두 arm 동일, 3100까지 이력 동일 | 시험(AB 3100+800, 1024env): 접지속도 1.24→0.98 m/s, GRF 피크 1.50→1.31 BW, 추종 유지, 스윙높이 0.116→0.080 m(감시) | 🔄 4k(vx1.2): AB 0.90 m/s·1.00 BW / RP 1.14·1.22 · 8k(vx1.6): **RP가 더 부드러움** 0.85·1.03 vs AB 0.93·1.23, 접지 p90 1.96 꼬리, ⚠AB 정지 제자리걸음(발움직임 0.115 m/s·duty 0.87→12k 재확인). 스윙 0.112/0.082 m > 역치 → w −1 유지. 1:1 영상·그림 [[93_ankle_ab_rp_comparison_plan]] §5c. 선형형은 해킹(2.42 m/s)으로 기각 — [[95_soft_landing_prescription]] |
