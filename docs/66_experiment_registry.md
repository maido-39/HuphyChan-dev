...
| **bundleCTL_AB / bundleTRT_AB** "flat-2.5max gen21-bundle+soft-landing **human-landing-bundle** ankle-AB (2026-08-26)" (1024 env, c3 `model_31999`에서 +800 iter → 32799, 🔄시험중) [[2026-08-26_bundleCTL_AB]] [[2026-08-26_bundleTRT_AB]] | 처치군만 **3변인 동시**: 초기자세 knee −38.4→**−20.05°**(`PYG_INIT_MID`) + **base_height deadband 앵커**(0.87±0.03, `PYG_BASE_HEIGHT_ANCHOR`) + soft-landing을 접지속도→**하중률**(60 ms dF_z/dt, `PYG_SOFT_LANDING_MODE=rate`). 대조군은 c3와 동일 | 🔄 판정 예정: 접지 무릎 ≤−15°(c3는 −30.5°) / GRF 2차 봉우리 / 스윙 −55~−65 유지 / 낙상 0 / 추종 열화 <10 % / ★air_time·stride 유지(하중률 해킹 감시) | 🔄 근거 [[2026-08-26_human_landing_bundle]], 원인 [[104_init_pose_gait_style]] |
