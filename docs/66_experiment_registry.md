...
| **ankleAB_c3 / ankleRP_c3** "flat-2.5max gen21-bundle+**soft-landing** curriculum-dr+push ankle-AB / -RP (2026-08-24)" (`03-22-35` / `03-22-58`, ✅**완주 32,000** 2026-08-25 23:06, 39 h 45 m, 각 model_3100 warm-start) [[2026-08-24_ankleAB_c3]] [[2026-08-24_ankleRP_c3]] | c2 + `PYG_SOFT_LANDING`(제곱 접지속도 w −1·h 0.10, GRF 캡 420/560) — 두 arm 동일, **유일 변인 = 발목 기구학** | **최종(32k, vx 2.5·DR 만배): 낙상 0.000 양쪽**, reward AB 87.6 / RP 88.1, ep_len 990 / 1000, err_vel(legacy) 1.151 / 1.208, low_base 0.167 / 0.083. 중간 분석: 에너지 **CoT RP 0.277 vs AB 0.314(−12 %)**, 충격 **무승부**(4게이트 쌍대차 < 표준편차), 모터 여유 **AB 압도**(발목 T-N 37 % vs 82 %·포화 3.7 %), 보폭 AB 273 vs RP 175 mm, 추종은 0.8 m/s AB / 1.2 m/s RP 우세 | 🔄 fc/fcp·전체격자 평가·§7 T-N 측정 진행 중 → 완료 시 판정. 분석: [[101_policy_spec_and_final_plan]] [[97_c3_reward_trend_review]] [[96_tracking_error_bottleneck]] [[95_soft_landing_prescription]] |
