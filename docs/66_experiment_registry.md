...
| **bundleCTL_AB / bundleTRT_AB** "human-landing-bundle ankle-AB (2026-08-26)" (1024 env, c3 `model_31999` +800 iter → 32798, ✅완주) [[2026-08-26_bundleCTL_AB]] [[2026-08-26_bundleTRT_AB]] | 처치군만 3변인 동시: 초기자세 knee −38.4→−20.05°(`PYG_INIT_MID`) + base_height deadband 앵커 + soft-landing 접지속도→**하중률**(`MODE=rate`, 접지속도 항 제거) | **기각**: 하중률 46.2→**84.5 BW/s(83 % 악화)**, 접지속도 0.873→**1.589**, **stride/s 1.40→0.93(−34 %) = 예측한 "발 안 떼기" 해킹**(duty는 0.57로 동일 — air_time만 봤으면 놓침). 성공률 100 %·추종 0.143 정상. 초기자세는 접지무릎 −47.9→**−42.9°(+5°)** 개선 | ⚠ 교란: 1024 env(본런의 1/16 배치)라 **대조군도 c3 대비 무릎 −17° 악화** → TRT vs CTL 비교로만 유효. 후속 `bundleB2_AB`(MODE=both) / `bundleB3_AB`(초기자세 단독) 진행 중. 근거 [[2026-08-26_human_landing_bundle]] §6 |
| **bundleB2_AB / bundleB3_AB** "landing-bundle 원인분리 (2026-08-26)" (1024 env, c3 `model_31999` +800 → 32798, ✅완주 — kill 후 와치독 자동 resume) [[2026-08-26_bundleB2_AB]] [[2026-08-26_bundleB3_AB]] | B2 = INIT_MID+앵커+**MODE=both**(접지속도 절반가중 유지) / B3 = **INIT_MID 단독** | B2: 접지속도 1.589→**1.171** 회복했으나 **하중률 79.7**(대조 46.2)로 여전히 목표 미달 → 하중률 항이 자기 목표를 못 이룬다. B3 측정 중 | 🔄 초기자세 컨벤션 조사 완료: 우리 −38.4°는 **mjlab G1 KNEES_BENT 상속**, 곧은 군집은 G1 17–24°·T1 22.9° → **−20°는 표준 대역**. mjlab엔 base_height 보상 부재(G1 −10·T1 −20) [[2026-08-26_init_pose_conventions]] |
| **bundleC3_AB / bundleC5_AB** "landing 세대2 — 초기자세 채택 + 무릎 직접항 (2026-08-26)" (**16384 env**, c3 `model_31999` +800 → 32799, 🔄) [[2026-08-26_bundleC3_AB]] [[2026-08-26_bundleC5_AB]] | C3 = `PYG_INIT_MID` 단독(B3의 본배치 확인) / C5 = INIT_MID + **`stance_knee_extension`**(신설, 입각 접촉게이트·스윙 무간섭, target 25°, w −2.0) | C5 중간: **`stance_knee_deg` 25.47°**(목표 수렴, 대조군 중간입각 −40.3° 대비 대폭 개선), 기여 −0.037(벌점 3.7 %), reward 83.5 vs C3 85.4(−2 %) | 🔄 앞선 세대에서 **base_height 앵커는 무력 판명**(base 0.8824가 deadband 안, 기여 −0.0019 — 높이·무릎이 힙피치로 분리). 근거 [[2026-08-26_human_landing_bundle]] §8, 선례 arXiv:2505.20619 |
