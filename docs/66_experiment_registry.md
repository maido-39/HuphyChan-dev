...
| **ankleAB_c3 / ankleRP_c3** "flat-2.5max gen21-bundle+**soft-landing** curriculum-dr+push ankle-AB / -RP (2026-08-24)" (`03-22-35` / `03-22-58`, 🔄학습중, 각 model_3100에서 warm-start, 총 32k) [[2026-08-24_ankleAB_c3]] [[2026-08-24_ankleRP_c3]] | c2 + `PYG_SOFT_LANDING` (foot_impact_velocity Σrelu(−v_z)²·[h<0.10∧공중] w −1, contact_force_cap 420/560 N) — 두 arm 동일, 3100까지 이력 동일 | 시험(AB 3100+800, 1024env): 접지속도 1.24→0.98 m/s, GRF 피크 1.50→1.31 BW, 추종 유지, 스윙높이 0.116→0.080 m(감시) | 🔄 4k 게이트(§95 §7): AB 접지 0.90 m/s·피크 1.00 BW·스윙 0.092 m / RP 1.14·1.22·0.081 — 해킹징후 0, w −1 유지. 선형형은 해킹(2.42 m/s)으로 기각 — [[95_soft_landing_prescription]] |
