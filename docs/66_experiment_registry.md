...
| **bundleP1_AB** "low-speed dead-zone fix (2026-08-27)" (16384 env, AB c3 `model_31999` +800 → 32798, ✅학습 완주·🔄평가 중) [[2026-08-27_bundleP1_AB]] | `PYG_LOWSPEED_DEADBAND=0.05` 단일 변인 (확정 레시피 위, 대조=bundleD1_AB의 0.3). 근거: 0.25 m/s에서 서기-방지 항 2개가 자기 문턱값(0.3/0.5)으로 구조적 비활성 [[2026-08-27_low_speed_command_research]] | 평가기 32 ep 채점 진행 중 — 0.25/0.5 달성률(본 지표)·cmd0 서기 보존·1.6 무회귀 | 🔄 판정 대기. 통과 시 V2 본학습 스택에 편입 |
