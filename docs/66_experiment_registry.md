...
| **legonly_ab_v3_keyfix** [[2026-09-05_legonly_ab_v3_keyfix]] | v2와 **유일 변인 = 시작 자세 수정**(v30 크랭크 축 미러에 맞춰 웅크림 키프레임 재풀이: L_crank_A/R_crank_B 부호 정정, base z 0.868→0.904 m, 발바닥 −31→+5 mm, 폐루프 찢김 37.23→0.00 mm). 보상·설정 33개 동일. 질문: 좌우 비대칭(무릎 14°, 크랭크 토크 1.4~1.5배)이 줄어드는가 | 2026-09-05 발사, 진행 중 |
