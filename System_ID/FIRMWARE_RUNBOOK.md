...
> ## ★★ 2026-09-09 저녁 — 이 절차는 **지금 하지 마십시오**
>
> 측정으로 범인이 밝혀졌습니다. **어댑터도 펌웨어도 문제가 아니었습니다.**
>
> | 어디서 · 어떻게 | 초당 프레임 |
> |---|---|
...
>
> 커널 계층은 1% 만 먹습니다. **48배 손실은 전부 가상머신 경계를 넘는 비용**입니다.
> 지금 펌웨어 그대로 **필요한 것(초당 1,000)의 11배**가 이미 나옵니다.
>
> 그러므로 **펌웨어를 바꿔도 원인은 그대로 남습니다.** 해야 할 일은 **제어를 가상머신 밖에서
> 돌리는 것** 하나입니다. 아래 절차는 나중에 필요해질 때를 위해 남겨 둡니다 — 준비물(두 파일,
> 설치 파일)은 이미 로봇에 있습니다.
